...
const DartsShirtsPage: React.FC = () => {
  ...
  const products: ProductCard[] = [
    {
      title: 'Classic Darts Shirts',
      image: 'https://images.pexels.com/photos/6577527/pexels-photo-6577527.jpeg',
      category: 'Classic',
      path: '/contact'
    },
    {
      title: 'Team Darts Shirts',
      image: 'https://images.pexels.com/photos/3621192/pexels-photo-3621192.jpeg',
      category: 'Team',
      path: '/contact'
    },
    {
      title: 'Custom Darts Shirts',
    ...
    <>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-lg text-rb-gray-300">
              Professional darts shirts designed for comfort and style at the oche
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-rb-black">
        <div className="container-custom text-center">
          ...
          >
            <h2 className="text-4xl font-bebas mb-6">Ready to Order Your Darts Shirts?</h2>
