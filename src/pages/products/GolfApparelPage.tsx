    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black texture-overlay relative">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">Golf Apparel</h1>
            <p className="text-lg text-rb-gray-300">
              Premium golf apparel designed for performance and style on the course
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-rb-black">
        <div className="container-custom text-center">
          ...
          >
            <h2 className="text-4xl font-bebas mb-6">Ready to Order Your Golf Apparel?</h2>
