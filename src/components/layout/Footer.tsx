          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                ...
                <a href="tel:+27823163330" className="flex items-center text-rb-gray-400 hover:text-rb-red transition-colors duration-200">
              ...
              <div className="space-y-2 pt-3 border-t border-rb-gray-800">
                ...
                <a href="tel:+27766890383" className="flex items-center text-rb-gray-400 hover:text-rb-red transition-colors duration-200">
