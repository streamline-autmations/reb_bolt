              ...
              <div className="bg-rb-gray-800 p-6 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-rb-white">Jan 2024</p>
                  </div>
                </div>
              </div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-rb-gray-400">
              Interactive catalogue viewer coming soon. Download the PDF for now.
            </p>
          </motion.div>
          ...
          >
            <div className="max-w-md mx-auto">
              ...
              <p className="text-rb-gray-400 mb-6">
                Our interactive flipbook catalogue is coming soon. For now, download the PDF version to browse our complete collection.
              </p>
